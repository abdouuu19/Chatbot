...
const MODELS = {
    conversation: 'microsoft/DialoGPT-medium', // DialoGPT-large often has issues
    advancedChat: 'facebook/blenderbot-400M-distill',
    
    // Alternative conversation models
    fallbackChat: 'microsoft/DialoGPT-small', // Smaller, more reliable
    
    // Translation models (separate from chat)
    translation: {
